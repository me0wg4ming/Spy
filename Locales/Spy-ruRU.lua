...
L["Ratchet"] = "Прибамбасск"
L["Nordanaar"] = "Норданаар"
L["Tel Co. Basecamp"] = "Базовый лагерь Тел'Ко."
...
L["MuteSoundInBattlegrounds"] = "Отключить звук в полях боя"
L["MuteSoundInBattlegroundsDescription"] = "Отключить все звуковые оповещения Spy на полях боя. Обнаружение и визуальные оповещения продолжают работать."
...
L["Always"] = "Удалять всегда"
L["AlwaysDescription"] = "Автоматически удалять информацию о противниках, которые давно не были обнаружены поблизости."
L["1Min"] = "1 минуты"
